...
namespace WeChat.NET.Controls
{
    ...
    class WChatList : ListBox
    {
            ...
            for (int i = 0; i < Items.Count; ++i)
            {
                ...
                if (user != null)
                {
                    ...
                    using (Font f = new System.Drawing.Font("微软雅黑", 11))
                    {
                        if (user.Icon != null)
                        {
                            e.Graphics.DrawImage(user.Icon, new Rectangle(bound.X + 10, bound.Y + 10, 30, 30));  //头像
                        }
                        e.Graphics.DrawString(user.ShowName, f, Brushes.Black, new PointF(bound.X + 50, bound.Y + 8)); //昵称
                    }
                    ...
                    if (list_unread != null)  //有未读消息
                    {
                        using (Font f2 = new Font("微软雅黑", 10))
                        {
                            ...
                            e.Graphics.DrawString(latest_msg, f2, new SolidBrush(Color.FromArgb(37, 37, 37)), new PointF(bound.X + 50, bound.Y + 30));
                        }
        ...
        protected override void OnDoubleClick(EventArgs e)
        {
            ...
            if (SelectedIndex != -1)
            {
                PublicWindows.messageBoxs.FriendUser = Items[SelectedIndex] as WXUser;
            }
        }
        /// <summary>
        /// 鼠标移动
        ...
        private void InitializeComponent()
        {
            ...
            // WChatList
            // 
            this.Size = new System.Drawing.Size(215, 446);
